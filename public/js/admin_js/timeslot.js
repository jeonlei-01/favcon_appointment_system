...
//for show and hide update button
document.addEventListener("DOMContentLoaded", function() {
  const updateButtonCells = document.querySelectorAll(".update-button-cell");

  updateButtonCells.forEach(cell => {
      const statusCell = cell.previousElementSibling; // Assuming the status cell is the previous sibling
